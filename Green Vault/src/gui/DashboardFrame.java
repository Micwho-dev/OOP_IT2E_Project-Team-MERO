...
public class DashboardFrame extends JFrame {
    ...
    private JPanel createSidebar() {
        ...
        addNavButton(sidebar, "🏠 Dashboard Overview", "OVERVIEW");
        
        // 2. Data Entry 
        if (role.equals("Garbage Collector") || role.equals("Barangay Member")) {
            addNavButton(sidebar, "➡️ Record Waste Data", "DATA_ENTRY"); 
        }
        
        // 3. Records Management 
        // Show for all roles except Barangay Member
        if (!role.equals("Barangay Member")) { 
             addNavButton(sidebar, "📋 Manage Waste Records", "RECORDS"); 
        }

        // 4. Reporting/Auditing 
        if (role.equals("City Officer") || role.equals("Barangay Captain")) {
            addNavButton(sidebar, "📈 Generate Reports/CSV", "REPORTS"); 
        }
        
        // 6. Request System
        if (role.equals("Barangay Member")) {
            addNavButton(sidebar, "📝 Create Request", "CREATE_REQUEST");
        }
        ...
        if (role.equals("City Officer")) {
            addNavButton(sidebar, "📋 View Requests for City Officer", "VIEW_CITY_REQUESTS");
        }
        ...
        if (role.equals("Admin")) {
             ...
             addNavButton(sidebar, "📈 System Statistics", "SYSTEM_STATS");
        }
    ...
    private JPanel createDataEntryPanel() {
        ...
        JButton submitBtn = new JButton("➕ Add Waste Record");
    ...
    private JPanel createRecordsPanel() {
        ...
        JButton editBtn = new JButton("✏️ Save Changes");
        ...
        JButton exportWasteBtn = new JButton("📄 Export Waste Records (CSV)");
    ...
    private JPanel createReportingPanel() {
        ...
        JButton exportCsvBtn = new JButton("⬇️ Export to CSV");
        ...
        JButton exportTxtBtn = new JButton("📄 Export to Text");
        ...
        JButton importCsvBtn = new JButton("⬆️ Import from CSV");
        ...
        if (!role.equals("Barangay Captain")) {
            JButton openReportsWindowBtn = new JButton("🪟 Open Reports Window");
    ...
    private JPanel createRequestPanel() {
        ...
        JButton wasteSubmitBtn = new JButton("📤 Submit Request");
        ...
        JButton equipmentSubmitBtn = new JButton("📤 Submit Request");
    ...
    private JPanel createBarangayCaptainRequestsPanel() {
        ...
        JButton approveBtn = new JButton("✅ Approve Forward to City Officer");
        approveBtn.setBackground(new Color(34, 139, 34));
        approveBtn.setForeground(Color.WHITE);
        approveBtn.addActionListener(e -> {
            int row = table.getSelectedRow();
    ...
    private JPanel createGarbageCollectorRequestsPanel() {
        ...
        JButton completeBtn = new JButton("✓ Mark as Collected");
